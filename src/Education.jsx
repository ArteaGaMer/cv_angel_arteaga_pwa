const features = [
    ...
    { name: 'Cisco Networking Academy', description: '| Introducción a IoT | Explicar cómo IoT y la transformación digital tienen un impacto positivo en las empresas y los gobiernos. Explicar la importancia que tienen el software y los datos para la sociedad y las empresas digitales. Explicar las ventajas de la automatización y la inteligencia artificial para la transformación digital. Explicar los conceptos de redes basadas en la intención. Explicar la necesidad de seguridad mejorada en el mundo digitalizado.' },
